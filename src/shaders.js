...
(function(namespace) {
    var Shaders = function(O) {
        ...
        me.secondPass_fs = [
            ...
            "    for (int x = 0; x < 16; x++) {",
            "        if(x == tex1Index) {",
            "            value1 = texture2D(uSliceMaps[x],texpos1);",
            "            value1Set = true;",
            "        }",

            "        if(x == tex2Index) {",
            "            value2 = texture2D(uSliceMaps[x],texpos2);",
            "            value2Set = true;",
            "        }",
            ...
            "        if(gray_val.r < 0.01 && gray_val.g < 0.01 && gray_val.b < 0.01) {",
            "           gray_val = vec4(0.0);",
            "        }",
            ...
            "            if(uAbsorptionModeIndex == 0.0)",
                ...
                "            sample.a = gray_val.a * uOpacityVal;",
                "            sample.rgb = gray_val.rgb * uColorVal;",
                "            accum += sample;",
                ...
                "            sample.a = gray_val.a * opacityFactor * (1.0 / uSteps);",
                "            sample.rgb = (1.0 - accum.a) * gray_val.rgb * sample.a * lightFactor;",
                "            accum += sample;",
                ...
                "            //colorValue = texture2D(uTransferFunction,tf_pos); " ,
                "            //colorValue = vec4(tf_pos.x, tf_pos.x, tf_pos.x, 1.0);",
                "            sample.a = gray_val.a * opacityFactor;",
                "            sample.rgb = gray_val.rgb * uColorVal;",
